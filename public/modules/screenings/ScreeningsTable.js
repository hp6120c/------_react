...
class ScreeningsTable extends React.Component{
	...
	render() {
		...
		return (
			...
			<UpdateModal3 show={this.props.show} thisScreenings={this.state.thisScreenings}  handleCancel={this.handleCancel.bind(this)} visible={this.state.visible}>{this.props.children}</UpdateModal3>
			</div>
		);
	}
}
